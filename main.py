...
plt.plot(calc['date'], calc['cross1'], marker='o', color='red')
plt.plot(calc['date'], calc['cross2'], marker='o', color='red')
plt.plot(calc['date'], calc['cross3'], marker='o', color='red')
...
plt.plot(calc['date'], calc['buyMom'], color='red', marker='o')
plt.plot(calc['date'], calc['sellMom'], color='blue', marker='o')
...
plt.plot(calc['date'], calc['buyRsiS'], color='red', marker='o')
plt.plot(calc['date'], calc['sellRsiS'], color='blue', marker='o')
plt.plot(calc['date'], calc['buyRsiW'], color='darkred', marker='o')
plt.plot(calc['date'], calc['sellRsiW'], color='navy', marker='o')
fig4.legend(
...
plt.plot(calc['date'], calc['buyKR'], color='red', marker='o')
plt.plot(calc['date'], calc['sellKR'], color='blue', marker='o')
...
plt.plot(calc['date'], calc['buyD'], color='red', marker='o')
plt.plot(calc['date'], calc['sellD'], color='blue', marker='o')
